...
//		//?†ÑÏ≤? Ï≤òÎ¶¨: allYN=true
//		if(allYN == true) 	sb.append("<option value=''>=?†ÑÏ≤?=</option>\n");
//		/*
...
//	}
	...
	public static String renderPaging(int maxNum_i, int currPageNoIn_i, int rowsPerPage_i, int bottomCount_i,
			...
			int maxNum = 0; // Ï¥? Í∞??àò
			int currPageNo = 1; // ?òÑ?û¨ ?éò?ù¥Ïß? Î≤àÌò∏ : page_num
			int rowPerPage = 10; // ?ïú?éò?ù¥Ïß??óê Î≥¥Ïó¨Ïß? ?ñâ?àò : page_size
			int bottomCount = 10; // Î∞îÎã•?óê Î≥¥Ïó¨Ïß? ?éò?ù¥Ïß? ?àò: 10
			...
			String url = url_i; // ?ò∏Ï∂? URL
			String scriptName = scriptName_i; // ?ò∏Ï∂? ?ûêÎ∞îÏä§?Å¨Î¶ΩÌä∏
