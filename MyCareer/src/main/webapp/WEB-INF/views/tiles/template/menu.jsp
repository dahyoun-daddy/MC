...
<body>
	...
	<div class="snb">
		<ul id="snb">
			<li class="s1"><a href="<%=contextPath%>/blog/post/post_doSearch.do?user_id=<%=user_id%>" style="text-decoration: none">포스팅</a></li>	
			<li id="pf_tmp_td" class="s2">
				<a id="pf_tmp" style="text-decoration: none">포트폴리오</a>
				<!-- 여기에 템플릿들이 추가 -->
			</li>
			<li class="s3"><a href="<%=contextPath%>/blog/resume/resume.do?user_id=<%=user_id%>" style="text-decoration: none">이력서</a></li>
			<li class="s4"><a href="<%=contextPath%>/blog/recruit/recruit.do?user_id=<%=user_id%>" style="text-decoration: none">공채목록</a></li>
		</ul>
	</div>
</body>
</html>