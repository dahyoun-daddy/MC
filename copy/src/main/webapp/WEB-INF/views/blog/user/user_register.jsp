...
int    withdraw_flag;   //탈퇴 여부(0:탈퇴, 1:존재)            
  -->
	...
	<div id="container" align="center">
		<div >
			<input type="text" id="user_id" name="user_id" placeholder="아이디" class="form-control">
			<span class="glyphicon glyphicon-user form-control-feedback"></span>
		</div>
		
		<div >
			<input type="password" id="user_password" name="user_password"  placeholder="비밀번호" class="form-control">
			<span class="glyphicon glyphicon-user form-control-feedback"></span>
		</div>
		<div>
			<input type="text" id="user_name" name="user_name"  placeholder="이름" class="form-control">
			<span class="glyphicon glyphicon-user form-control-feedback"></span>
		</div>
		<div>
		...
		<div>
			<input type="text" id="user_div" name="user_div" placeholder="회원구분" value="1" class="form-control">
			<span class="glyphicon glyphicon-user form-control-feedback"></span>
		</div>
		<div>
			<input type="text" id="age" name="age"  placeholder="나이"  class="form-control">
			<span class="glyphicon glyphicon-user form-control-feedback"></span>
		</div>
		<div>
